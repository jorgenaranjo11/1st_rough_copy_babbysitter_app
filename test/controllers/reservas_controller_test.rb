...
class ReservasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post reservas_url, params: { reserva: { de: @reserva.de, direccion: @reserva.direccion, hasta: @reserva.hasta, hijos: @reserva.hijos } }
    end
  ...
  test "should update reserva" do
    patch reserva_url(@reserva), params: { reserva: { de: @reserva.de, direccion: @reserva.direccion, hasta: @reserva.hasta, hijos: @reserva.hijos } }
