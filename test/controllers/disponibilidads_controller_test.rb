...
class DisponibilidadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create disponibilidad" do
    assert_difference('Disponibilidad.count') do
      post disponibilidads_url, params: { disponibilidad: { fecha: @disponibilidad.fecha, manana: @disponibilidad.manana, noche: @disponibilidad.noche, tarde: @disponibilidad.tarde } }
    end
  ...
  test "should update disponibilidad" do
    patch disponibilidad_url(@disponibilidad), params: { disponibilidad: { fecha: @disponibilidad.fecha, manana: @disponibilidad.manana, noche: @disponibilidad.noche, tarde: @disponibilidad.tarde } }
